...
company_emp_df = spark.read.option('header','true').option('multiline','true').schema(company_emp_schema).csv(company_emp_path)
...
company_ind_df = spark.read.option('header','true').option('multiline','true').schema(company_ind_schema).csv(company_ind_path)
